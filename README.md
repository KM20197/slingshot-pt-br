...
- Catálogo estruturado: 2.546 campos tratados, com 2.494 alterações de texto. As 14 primeiras estruturas foram examinadas; cinco estruturas de identificadores ou gráficos foram preservadas integralmente. Os 12 modelos de negócio de `BMC_DATA` estão cobertos (1.826 campos), incluindo marcos, mudanças estratégicas e seletores de remoção. Também foram tratados os cinco modelos de receita, os 12 perfis de fundadores (216 campos) e suas 12 descrições de fomento. O restante do conteúdo ainda não foi traduzido por completo.
