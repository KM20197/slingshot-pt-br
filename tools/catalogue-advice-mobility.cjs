...
const hashes={FUNDER_ADVICE:'02cb400289da66bc466aa0b48dc6b7292e234d91e8c20c47bc3ff5d8629db1a2'};
...
fs.writeFileSync(file,JSON.stringify(catalogue,null,2)+'\n');console.log('FUNDER_ADVICE (Mobility+Enterprise+PLG): '+Object.keys(ordered).length+' campos.');
